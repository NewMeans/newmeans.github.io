...
(function () {
  ...
  var CAP_ICONS = [
    ...
    '<svg viewBox="0 0 24 24" aria-hidden="true"><text x="10.5" y="16.1" text-anchor="end">Lo</text><rect x="10.8" y="11.95" width="3.1" height="1.6" rx=".8"/><text x="14.2" y="16.1" text-anchor="start">Fi</text></svg>'
  ];
  ...
  var GROUND_OBS = [
    { tone: 'coral', svg: '<svg viewBox="0 0 40 40"><path d="M20 3 36 33a2.4 2.4 0 0 1-2.1 3.6H6.1A2.4 2.4 0 0 1 4 33z" fill="var(--ob-a)"/><circle cx="15" cy="24" r="2.6" fill="var(--ob-b)"/><circle cx="25" cy="27" r="2.6" fill="var(--ob-b)"/><circle cx="20" cy="17" r="2.1" fill="var(--ob-b)"/></svg>' },
    { tone: 'sand', svg: '<svg viewBox="0 0 40 40"><rect x="7" y="7" width="26" height="19" rx="2.6" fill="var(--ob-a)"/><rect x="10" y="10" width="20" height="13" rx="1.4" fill="var(--ob-b)" opacity=".5"/><path d="M3 28h34l-1.4 4.4a2 2 0 0 1-1.9 1.4H6.3a2 2 0 0 1-1.9-1.4z" fill="var(--ob-a)"/></svg>' },
    { tone: 'sand', svg: '<svg viewBox="0 0 40 40"><rect x="8" y="5" width="24" height="30" rx="2.4" fill="var(--ob-a)" transform="rotate(-6 20 20)"/><rect x="8" y="5" width="24" height="30" rx="2.4" fill="var(--ob-a)" transform="rotate(5 20 20)"/><path d="M14 14h13M14 20h13M14 26h8" stroke="var(--ob-b)" stroke-width="2.4" stroke-linecap="round" fill="none"/></svg>' },
    { tone: 'gold', svg: '<svg viewBox="0 0 40 40"><rect x="5" y="11" width="30" height="19" rx="3" fill="var(--ob-a)"/><path d="M5 17h30M20 11v19" stroke="var(--ob-b)" stroke-width="2.6" fill="none"/><path d="M20 11c-4-6-11-4-9 1 1 2.6 5.6 2.6 9-1zM20 11c4-6 11-4 9 1-1 2.6-5.6 2.6-9-1z" fill="var(--ob-b)"/></svg>' },
    { tone: 'mint', svg: '<svg viewBox="0 0 40 40"><rect x="6" y="8" width="28" height="24" rx="4" fill="var(--ob-a)"/><rect x="10" y="12" width="20" height="12" rx="2" fill="var(--ob-b)" opacity=".45"/><circle cx="14" cy="28" r="1.8" fill="var(--ob-b)"/><circle cx="20" cy="28" r="1.8" fill="var(--ob-b)"/><circle cx="26" cy="28" r="1.8" fill="var(--ob-b)"/></svg>' },
    { tone: 'coral', svg: '<svg viewBox="0 0 40 40"><rect x="4" y="7" width="28" height="7" rx="1.8" fill="var(--ob-a)"/><rect x="8" y="16" width="28" height="7" rx="1.8" fill="var(--ob-b)"/><rect x="5" y="25" width="30" height="7" rx="1.8" fill="var(--ob-a)"/></svg>' },
    { tone: 'gold', svg: '<svg viewBox="0 0 40 40"><circle cx="20" cy="23" r="13" fill="var(--ob-a)"/><circle cx="20" cy="23" r="13" fill="none" stroke="var(--ob-b)" stroke-width="2.2"/><path d="M20 15v8l5 3" stroke="var(--ob-b)" stroke-width="2.8" stroke-linecap="round" fill="none"/><path d="M9 8l5 4M31 8l-5 4" stroke="var(--ob-b)" stroke-width="3.2" stroke-linecap="round"/></svg>' },
    { tone: 'gold', svg: '<svg viewBox="0 0 40 40"><path d="M20 3a12 12 0 0 0-7 21.7V28h14v-3.3A12 12 0 0 0 20 3z" fill="var(--ob-a)"/><rect x="13.6" y="29.6" width="12.8" height="3.6" rx="1.8" fill="var(--ob-b)"/><rect x="15.4" y="34.4" width="9.2" height="3.4" rx="1.7" fill="var(--ob-b)"/></svg>' },
  ...
  var AIR_OBS = [
    ...
    { tone: 'coral', svg: '<svg viewBox="0 0 40 40"><path d="M20 34S5 25.4 5 16.2A8.6 8.6 0 0 1 20 10.4a8.6 8.6 0 0 1 15 5.8C35 25.4 20 34 20 34z" fill="var(--ob-a)"/></svg>' },
    { tone: 'mint', svg: '<svg viewBox="0 0 40 40"><path d="M7 7h26a4 4 0 0 1 4 4v12a4 4 0 0 1-4 4H19l-8 6.6V27H7a4 4 0 0 1-4-4V11a4 4 0 0 1 4-4z" fill="var(--ob-a)"/><circle cx="14" cy="17" r="2.2" fill="var(--ob-b)"/><circle cx="20" cy="17" r="2.2" fill="var(--ob-b)"/><circle cx="26" cy="17" r="2.2" fill="var(--ob-b)"/></svg>' },
    { tone: 'gold', svg: '<svg viewBox="0 0 40 40"><path d="M20 4a3 3 0 0 1 3 3v1.4A10 10 0 0 1 30 18v7.2l3 3.8H7l3-3.8V18a10 10 0 0 1 7-9.6V7a3 3 0 0 1 3-3z" fill="var(--ob-a)"/><path d="M15.8 31.2a4.2 4.2 0 0 0 8.4 0z" fill="var(--ob-b)"/></svg>' },
    { tone: 'mint', svg: '<svg viewBox="0 0 40 40"><path d="M12 30.5a8.2 8.2 0 0 1 .6-16.4 11.2 11.2 0 0 1 21-3.3 6.8 6.8 0 0 1-2 19.7z" fill="var(--ob-a)"/></svg>' }
  ];
