...
(function () {
  ...
  var STRINGS = {
    ko: {
      ...
      "typer.kit": "스위치 7종 · 키캡 8종 · 프레임 8종 · 모니터 4종",
      "dopa.flow": "카톡 대화 하나 → AI 연구 보고서",
      ...
      "dopa.unique.short": "2,000명이 하면 2,000개의 결과",
      ...
      "home.typer.hint": "키캡이 부서질 때마다 타건음",
      ...
      "home.dopa.hint": "내 카톡으로 보는 나의 다른 모습",
      "dopa.report": "연구 보고서",
      "dopa.teto": "테토",
      "dopa.egen": "에겐",
    ...
    en: {
      ...
      "typer.kit": "7 switches · 8 keycap sets · 8 frames · 4 monitors",
      "dopa.flow": "One chat export → an AI research report",
      ...
      "dopa.unique.short": "2,000 people, 2,000 different results",
      ...
      "home.typer.hint": "A switch sound for every keycap that breaks",
      ...
      "home.dopa.hint": "Another side of you, read from your chats",
      "dopa.report": "Research report",
      "dopa.teto": "Teto",
      "dopa.egen": "Egen",
