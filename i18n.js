...
(function () {
  ...
  var STRINGS = {
    ko: {
      ...
      "dopa.review.2": "진짜 제가 했던 말들이 그대로 나와서 좀 소름이었습니다...",
      "dopa.review.3": "친구랑 해보고 단톡방 네 개 다 돌렸어요 다들 난리남",
      "dopa.review.4": "솔직히 기대 안 했는데 생각보다 정확해서 놀랐습니다",
      "dopa.review.5": "결과 나오자마자 캡처부터 떴네요",
      "dopa.review.6": "이 퀄리티가 무료라니",
    ...
    en: {
      ...
      "dopa.review.2": "It pulled out things I actually said. A bit too accurate honestly.",
      "dopa.review.3": "Did it with a friend, then ran four group chats through it. Everyone lost it.",
      "dopa.review.4": "Did not expect much and then it got me. Surprisingly sharp.",
      "dopa.review.5": "Screenshot was out before I had finished reading.",
      "dopa.review.6": "Cannot believe this costs nothing.",
