...
(function () {
  ...
  var STRINGS = {
    ko: {
      ...
      "home.typer.sub": "키보드로 치는 한 판. 공이 키캡을 부술 때마다 고른 스위치의 타건음.",
    ...
    en: {
      ...
      "home.typer.sub": "One round, played on your keyboard. Every keycap the ball breaks plays the switch you picked.",
