...
(function () {
  ...
  var STRINGS = {
    ko: {
      "meta.title": "NewMeans — 게임 & AI 스튜디오",
      "meta.description": "NewMeans는 게임과 AI를 만드는 2인 스튜디오입니다.",
      "nav.skip": "본문으로 건너뛰기",
      "nav.works": "제품",
      "nav.products": "제품",
      "nav.studio": "스튜디오",
      "home.tag": "게임과 AI를 만드는 2인 스튜디오",
      "home.seeProducts": "제품 보기",
      "home.contact": "문의하기",
      "home.products": "제품",
      "home.typer.chip": "게임 · iOS / Android",
      "home.typer.tag": "기계식 키보드 타건음 아케이드",
      "home.typer.hint": "키캡을 눌러 타건음을 들어보세요",
      "home.more": "자세히 보기",
      "home.dopa.chip": "AI 심리테스트 · Web",
      "home.dopa.tag": "대화를 분석하는 AI 심리테스트.",
      "home.dopa.analyzing": "AI 분석 중",
      "home.dopa.msg1": "나 요즘 자꾸 밤에 폰만 봐 ㅠ",
      "home.dopa.msg2": "오 그거 도파민 신호일지도?",
    ...
    en: {
      "meta.title": "NewMeans — a games & AI studio",
      "meta.description": "NewMeans is a two-person studio making games and AI.",
      "nav.skip": "Skip to content",
      "nav.works": "Works",
      "nav.products": "Products",
      "nav.studio": "Studio",
      "home.tag": "Games & AI, by two.",
      "home.seeProducts": "See products",
      "home.contact": "Contact",
      "home.products": "Products",
      "home.typer.chip": "Game · iOS / Android",
      "home.typer.tag": "A mechanical-keyboard arcade.",
      "home.typer.hint": "Press a key to hear the sound",
      "home.more": "View project",
      "home.dopa.chip": "AI psych test · Web",
      "home.dopa.tag": "AI personality test from your chats.",
      "home.dopa.analyzing": "AI analyzing",
      "home.dopa.msg1": "i keep scrolling my phone all night ㅠ",
      "home.dopa.msg2": "ooh that might be a dopamine signal?",
