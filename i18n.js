...
(function () {
  ...
  var STRINGS = {
    ko: {
      ...
      "home.studio.lead": "일상의 작은 즐거움을 만드는 스튜디오",
      "home.studio.l1": "게임이든 AI든, 감각적이고 재밌는 디지털 경험",
      "home.studio.l2": "둘이서 기획부터 운영까지 전부",
      "home.studio.l3": "작게 만들어 오래 다듬기",
    ...
    en: {
      ...
      "home.studio.lead": "A studio for small everyday joys",
      "home.studio.l1": "Games or AI: sensory, playful digital experiences",
      "home.studio.l2": "Two people, from the idea to running it",
      "home.studio.l3": "Made small, refined for a long time",
