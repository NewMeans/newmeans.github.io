...
(function () {
  ...
  var STRINGS = {
    ko: {
      ...
      "dopa.review.4": "생각보다 너무 정확해서 몇 번을 다시 읽었어요",
      "dopa.review.5": "결과 나오자마자 친구한테 캡처부터 보냈습니다",
      "dopa.review.6": "이게 왜 무료인지 모르겠어요",
    ...
    en: {
      ...
      "dopa.review.4": "Closer to the mark than I expected. I read it three times.",
      "dopa.review.5": "Screenshotted it to a friend before I finished reading.",
      "dopa.review.6": "I do not understand how this is free.",
